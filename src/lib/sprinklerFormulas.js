...
export function calculateSprinklerTakeoff(inputs, materialPriceMap = {}) {
  ...
  const laborLines = [
    ...
    { item: "HANGERS",                   quantity: totalHandlers,           factor: 0.25 },
    { item: "SEISMIC BRACING",           quantity: seismic_braces,          factor: 0.75 },
    { item: "THREADED FITTINGS",         quantity: totalThreadedFittings,   factor: 0.20 },
    { item: "GROOVED FITTINGS",          quantity: totalGroovedFittings,    factor: 0.35 },
    { item: "WELDED FITTINGS",           quantity: totalWeldedFittings,     factor: 0.50 },
    { item: "VALVES",                    quantity: totalGateValves,         factor: 0.75 },
